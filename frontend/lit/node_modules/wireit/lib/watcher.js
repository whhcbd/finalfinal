...
export class Watcher {
    ...
    async #analyze() {
        ...
        const staleConfigWatcherSignatures = new Set(this.#configFileWatchers.keys());
        for (const globGroup of result.relevantConfigGlobGroups) {
            ...
            if (existingWatcher === undefined) {
                const watcher = makeWatcher(globGroup.patterns, globGroup.cwd ?? '/', this.#onConfigFileChanged, true, this.#watchOptions);
