...
import { failUnlessArray, failUnlessJsonObject, failUnlessKeyValue, failUnlessNonBlankString, } from '../analyzer.js';
...
export class PackageJson {
    ...
    #analyzeWorkspacesSection(failures) {
        const workspacesSectionResult = findNamedNodeAtLocation(this.#fileAstNode, ['workspaces'], this.jsonFile);
    ...
    #analyzeDependencies(failures, dev) {
        const prodDepsResult = findNamedNodeAtLocation(this.#fileAstNode, [dev ? 'devDependencies' : 'dependencies'], this.jsonFile);
